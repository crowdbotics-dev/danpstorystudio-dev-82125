...
## Project Structure
    ...
    ├── danpstorystudio_dev_82125  # Django project configurations
...
1. Clone this repo and `cd danpstorystudio_dev_82125`
...
2. Clone this repo and `cd danpstorystudio_dev_82125`
